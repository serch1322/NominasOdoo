...
class HrPayslip(models.Model):
    ...
    def _get_inability_data(self, line):
        ...
        if line.salary_rule_id in self.env.ref('l10n_mx_edi_payslip.hr_rule_l10n_mx_payroll_deduction_006_irt') | \
        ...
        if line.salary_rule_id in self.env.ref('l10n_mx_edi_payslip.hr_rule_l10n_mx_payroll_deduction_006') | \
        ...
        if line.salary_rule_id in self.env.ref('l10n_mx_edi_payslip.hr_rule_l10n_mx_payroll_deduction_006_im') | \
        ...
        if line.salary_rule_id in self.env.ref('l10n_mx_edi_payslip.hr_rule_l10n_mx_payroll_deduction_006_lphc') | \
...
class HrPayslipRun(models.Model):
    ...
    l10n_mx_edi_payment_date = fields.Date(
        'Payment Date', required=True, copy=False,
        default=time.strftime('%Y-%m-01'), help='Save the payment date that '
